...
Refunds at Marketly are evaluated on a case-by-case basis. Digital products that have been delivered and accessed are generally non-refundable. If you experience a technical issue or have not received your order within 24 hours, please contact our support team with your order details. Approved refunds are processed to your Marketly wallet balance within 3–5 business days. Chargebacks initiated through your payment provider without prior contact may result in account suspension. VIP membership upgrades and one-time fee payments are non-refundable once activated. We reserve the right to deny refund requests that appear fraudulent or abusive.', 'legal');
    ...
    {
        $categories = [
            ['name' => 'Games', 'name_ar' => 'الألعاب', 'type' => CategoryType::Auto, 'icon' => 'gamepad', 'sort_order' => 1, 'description' => 'Game keys, accounts, and in-game items', 'description_ar' => 'مفاتيح الألعاب والحسابات والعناصر داخل الألعاب', 'image_url' => 'https://loremflickr.com/320/240/gamepad'],
            ['name' => 'Chat Applications', 'name_ar' => 'تطبيقات الدردشة', 'type' => CategoryType::Auto, 'icon' => 'message', 'sort_order' => 2, 'description' => 'Premium subscriptions for chat and messaging apps', 'description_ar' => 'اشتراكات مميزة لتطبيقات الدردشة والرسائل', 'image_url' => 'https://loremflickr.com/320/240/chat'],
            ['name' => 'Cards', 'name_ar' => 'البطاقات', 'type' => CategoryType::Auto, 'icon' => 'credit-card', 'sort_order' => 3, 'description' => 'Gift and prepaid cards', 'description_ar' => 'البطاقات الهدية والبطاقات مسبقة الدفع', 'image_url' => 'https://loremflickr.com/320/240/credit-card'],
            ['name' => 'Balance Top-ups', 'name_ar' => 'شحن الرصيد', 'type' => CategoryType::Auto, 'icon' => 'wallet', 'sort_order' => 4, 'description' => 'Mobile balance and top-ups', 'description_ar' => 'شحن رصيد الهاتف وإعادة الشحن', 'image_url' => 'https://loremflickr.com/320/240/wallet'],
            ['name' => 'Design Programs', 'name_ar' => 'برامج التصميم', 'type' => CategoryType::Auto, 'icon' => 'design', 'sort_order' => 5, 'description' => 'Software licenses for design tools', 'description_ar' => 'تراخيص برامج التصميم', 'image_url' => 'https://loremflickr.com/320/240/design'],
            ['name' => 'Screen Subscriptions', 'name_ar' => 'اشتراكات البث', 'type' => CategoryType::Auto, 'icon' => 'monitor', 'sort_order' => 6, 'description' => 'Streaming service subscriptions', 'description_ar' => 'اشتراكات خدمات البث', 'image_url' => 'https://loremflickr.com/320/240/streaming'],
            ['name' => 'VPN Subscriptions', 'name_ar' => 'اشتراكات VPN', 'type' => CategoryType::Auto, 'icon' => 'server', 'sort_order' => 7, 'description' => 'VPN access plans', 'description_ar' => 'خطط الوصول إلى VPN', 'image_url' => 'https://loremflickr.com/320/240/security'],
            ['name' => 'Account Verification', 'name_ar' => 'التحقق من الحسابات', 'type' => CategoryType::Manual, 'icon' => 'check-circle', 'sort_order' => 8, 'description' => 'Manual account verification services', 'description_ar' => 'خدمات التحقق اليدوية من الحسابات', 'image_url' => 'https://loremflickr.com/320/240/checkmark'],
            ['name' => 'Artificial Intelligence', 'name_ar' => 'الذكاء الاصطناعي', 'type' => CategoryType::Auto, 'icon' => 'cpu', 'sort_order' => 9, 'description' => 'AI tool subscriptions', 'description_ar' => 'اشتراكات أدوات الذكاء الاصطناعي', 'image_url' => 'https://loremflickr.com/320/240/robotics'],
            ['name' => 'Manual Charging & Store Offers', 'name_ar' => 'الشحن اليدوي وعروض المتجر', 'type' => CategoryType::Manual, 'icon' => 'handshake', 'sort_order' => 10, 'description' => 'Custom store offers and manual charging', 'description_ar' => 'عروض المتجر المخصصة والشحن اليدوي', 'image_url' => 'https://loremflickr.com/320/240/handshake'],
            ['name' => 'Social Media Services', 'name_ar' => 'خدمات التواصل الاجتماعي', 'type' => CategoryType::Manual, 'icon' => 'share', 'sort_order' => 11, 'description' => 'Telegram, Facebook, Twitter and other social media services', 'description_ar' => 'تيليجرام وفيسبوك وتويتر وخدمات التواصل الاجتماعي الأخرى', 'image_url' => 'https://loremflickr.com/320/240/social-media'],
        ];
    ...
    private function seedProducts(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'stock' => 100,
                'store' => $store?->id,
                'image_url' => 'https://loremflickr.com/320/240/gaming',
            ...
            [
                ...
                'stock' => 200,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/telegram',
            ...
            [
                ...
                'stock' => 200,
                'store' => $store?->id,
                'image_url' => 'https://loremflickr.com/320/240/gift',
            ...
            [
                ...
                'stock' => 500,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/mobile',
            ...
            [
                ...
                'stock' => 40,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/graphic-design',
            ...
            [
                ...
                'stock' => 25,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/ui-design',
            ...
            [
                ...
                'stock' => 100,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/movie',
            ...
            [
                ...
                'stock' => 80,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/music',
            ...
            [
                ...
                'stock' => 60,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/vpn',
            ...
            [
                ...
                'image_url' => 'https://loremflickr.com/320/240/social-media',
            ...
            [
                ...
                'stock' => 100,
                'store' => null,
                'image_url' => 'https://loremflickr.com/320/240/robotics',
            ...
            [
                ...
                'stock' => 999,
                'type' => CategoryType::Manual,
                'image_url' => 'https://loremflickr.com/320/240/store',
