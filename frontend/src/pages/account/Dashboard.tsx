...
const QUICK_ACTIONS = [
  ...
  { to: '/dashboard/favorites', label: 'admin.favorites', icon: 'favorites', color: 'secondary' },
  { to: '/dashboard/deposits', label: 'admin.depositHistory', icon: 'depositHistory', color: 'secondary' },
];
